...
[ApiController, AllowAnonymous, Route("api/webhooks/pomelo/presentments/v1/notifications")]
public sealed class PomeloPresentmentsWebhookController(
    IPomeloWebhookVerifier verifier,
    PomeloPresentmentService service) : ControllerBase
{
