...
[ApiController, AllowAnonymous, Route("api/webhooks/pomelo/reverted-operations")]
public sealed class PomeloRevertedOperationsWebhookController(
    IPomeloWebhookVerifier verifier, PomeloRevertedOperationService service) : ControllerBase
{
