...
public sealed class WebhookRouteTests
{
    ...
    [InlineData(typeof(PomeloStatementCreatedWebhookController), "api/webhooks/pomelo/statements/created-summaries")]
    ...
    [InlineData(typeof(PomeloDelinquencyWebhookController), "api/webhooks/pomelo/credit-lines/delinquency")]
