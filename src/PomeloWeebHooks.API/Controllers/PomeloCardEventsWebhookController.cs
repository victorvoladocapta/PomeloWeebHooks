...
[ApiController]
[AllowAnonymous]
[Route("api/webhooks/pomelo/cards/v1/cards/events")]
public sealed class PomeloCardEventsWebhookController(
    IPomeloWebhookVerifier verifier,
    PomeloCardEventService service,
    ILogger<PomeloCardEventsWebhookController> logger) : ControllerBase
{
    [HttpPost]
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogWarning("Pomelo Card Events rechazado por firma o headers inválidos");
            return Unauthorized();
        }
