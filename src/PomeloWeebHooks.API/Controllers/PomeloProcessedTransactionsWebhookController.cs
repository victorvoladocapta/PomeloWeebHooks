...
[ApiController, AllowAnonymous, Route("api/webhooks/pomelo/lending/transactions")]
public sealed class PomeloProcessedTransactionsWebhookController(
    IPomeloWebhookVerifier verifier, PomeloProcessedTransactionService service) : ControllerBase
{
        ...
        CancellationToken ct)
    {
        ...
        if (!verifier.IsValid(apiKey, signature, timestamp, endpoint, Request.Path + Request.QueryString, body)) return Unauthorized();
