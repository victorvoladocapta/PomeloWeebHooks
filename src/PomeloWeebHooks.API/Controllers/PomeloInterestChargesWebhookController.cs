...
[ApiController, AllowAnonymous, Route("api/webhooks/pomelo/credit-lines/interest-charges")]
public sealed class PomeloInterestChargesWebhookController(
    IPomeloWebhookVerifier verifier,
    PomeloInterestChargeService service) : ControllerBase
{
