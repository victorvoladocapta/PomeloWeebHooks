...
[ApiController, AllowAnonymous, Route("api/webhooks/pomelo/users/v1/status-changed")]
public sealed class PomeloUserStatusWebhookController(
    IPomeloWebhookVerifier verifier,
    PomeloUserStatusService service) : ControllerBase
{
